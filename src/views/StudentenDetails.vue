<template>
  <div class="student-details">
    ...
    <div class="week-selector">
      ...
      <select v-model="selectedWeek" @change="updateWeekData" class="week-dropdown">
...
export default {
  ...
  data() {
    return {
      ...
      // Default leeg, wordt gevuld via methodes op basis van student id
  ...
  methods: {
    updateWeekData() {
      // Voor toekomstige functionaliteit
      console.log(`Selected week changed to: ${this.selectedWeek}`);
    },
    loadStudentDataFromRoute() {
      // Haal studentId uit de route params
      const studentId = this.$route.params.studentId;
      // Simuleer database/studentenlijst (vervang door een fetch als je een backend hebt)
      const studentMap = {
      ...
      if (studentMap[studentId]) {
        this.selectedStudent = studentMap[studentId];
      } else {
        this.selectedStudent = { nr: "Onbekend", name: "Onbekend", group: "-" };
      }
      // Vul aanwezigheid info
...
<style src="./StudentenDetails.css"></style>